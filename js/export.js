...
const exportManager = (() => {
    ...
    async function exportAsText() {
        try {
            ...
            // Create header
            let textContent = 'DAILY REFLECTION JOURNAL\n';
            textContent += '=======================\n\n';
...
<head>
    ...
    <title>Daily Reflection Journal - Export</title>
    <style>
        body {
        ...
        try {
            ...
            switch (format.toLowerCase()) {
                case 'json':
                    ...
                    downloadFile(
                        jsonContent,
                        `daily-reflection-journal_${dateStr}.json`,
                        'application/json'
                    );
                    break;
                ...
                case 'text':
                    ...
                    downloadFile(
                        textContent,
                        `daily-reflection-journal_${dateStr}.txt`,
                        'text/plain'
                    );
                    break;
                ...
                case 'html':
                    ...
                    downloadFile(
                        htmlContent,
                        `daily-reflection-journal_${dateStr}.html`,
                        'text/html'
                    );
                    break;
                ...
                case 'pdf':
                    ...
                    downloadFile(
                        pdfBlob,
                        `daily-reflection-journal_${dateStr}.pdf`,
                        'application/pdf'
                    );
                    break;
